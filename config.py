...
special_date: list = ['2026-07-04', '2026-07-11', '2026-07-18', '2026-07-25']
...
# 版本福利配置（可选）。
version_gift_activity_id: Optional[str] = '947081'  # 版本福利活动ID。
version_gift_play_flow_id: Optional[str] = '1226032'  # 游玩一局礼包。
