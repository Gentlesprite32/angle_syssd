...
version_gift_share_flow_id: Optional[str] = str(int(version_gift_play_flow_id) + 1)  # 分享礼包。
version_gift_flow_id: Optional[str] = str(int(version_gift_play_flow_id) + 2)  # 抽奖。
